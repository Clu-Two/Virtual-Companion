...
void formatting::Companion(ImGuiStyle* dst)
{
...
void formatting::lifestats(ImGuiStyle* life_stats)
{
    ...
    void formatting::ProgressBar_Alt(float fraction, const ImVec2& size_arg, const char* left_overlay = nullptr, const char* right_overlay = nullptr, ImU32 fill_color = ImGui::GetColorU32(ImGuiCol_PlotHistogram), ImU32 bk_color = ImGui::GetColorU32(ImGuiCol_FrameBg))
    {
    ...
    void formatting::ProgressBar_Vertical(float fraction, const ImVec2& size_arg, const char* overlay = nullptr, ImU32 fill_color = ImGui::GetColorU32(ImGuiCol_PlotHistogram), ImU32 bk_color = ImGui::GetColorU32(ImGuiCol_FrameBg))
    {
        ImGuiWindow* window = ImGui::GetCurrentWindow();
        if (window->SkipItems)
            return;
